...
local function createButton(option, parent)
	...
	local Button = library:Create("TextButton", {
		Name = "Button",
		BackgroundTransparency = 1,
		Position = UDim2.new(0.05, 0, 0.081, 0),
...
local function createKeybind(option, parent)
	...
	local KeybindText = library:Create("TextLabel", {
		Name = "KeybindText",
		BackgroundTransparency = 1,
		Position = UDim2.new(0.05, 0, 0.162, 0),
	...
	local KeybindBox = library:Create("TextButton", {
		Name = "KeybindBox",
		BackgroundTransparency = 1,
		Position = UDim2.new(0.52, 0, 0.243, 0),
		Size = UDim2.new(0, 65, 0, 23),
		ZIndex = 4,
		Font = Enum.Font.SourceSansSemibold,
		LineHeight = 1.5,
...
local function createToggle(option, parent)
	...
	local ToggleImage = library:Create("ImageLabel", {
		Name = "ToggleImage",
		BackgroundTransparency = 1,
		Position = UDim2.new(0.8, 0, 0.081, 0),
...
local function createSlider(option, parent)
	...
	local SliderFrame = library:Create("TextButton", {
		...
		BorderSizePixel = 0,
		Position = UDim2.new(0.05, 0, 0.5405, 0),
		Size = UDim2.new(0, 135, 0, 5),
		ZIndex = 3,
		Text = "",
		Parent = SliderHolder
	})
	...
	SliderFrame.MouseButton1Down:Connect(function()
		pcall(function()
			...
			Connection = RunService.RenderStepped:Connect(function()
				...
				Slider.Size = UDim2.new(Percentage, 0, 0, 5)
...
local function createDropdown(option, parent)
	...
	ListLayout.Changed:Connect(function()
		...
		local maxHeight = math.min(ListLayout.AbsoluteContentSize.Y, 100)
...
function library:CreateWindow(WName)
	...
	local Holder = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
		Position = UDim2.new(0, (15 + (152 * library.count) - 150), 0.002, 0),
		Size = UDim2.new(0, 150, 0, 39),
		ZIndex = 5,
		Image = "rbxassetid://3570695787",
	...
	local WindowText = library:Create("TextLabel", {
		...
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
		Position = UDim2.new(0.05, 0, 0.154, 0),
		Size = UDim2.new(0, 120, 0, 27),
		ZIndex = 5,
		Font = Enum.Font.SourceSans,
		Text = WName,
		TextColor3 = Color3.fromRGB(255, 255, 255),
	...
	ToggleGUI.MouseButton1Click:Connect(function()
		pcall(function()
			...
			local targetSize = ui.opened and UDim2.new(0, 150, 0, y) or UDim2.new(0, 150, 0, 37)
	...
	function ui:Resize()
		pcall(function()
			...
			Container.Size = UDim2.new(0, 150, 0, y + 2)
		end)
	end
