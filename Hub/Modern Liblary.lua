...
Info.Logo = Info.Logo or nil -- Add logo parameter
...
topbar.Name = "Topbar"
topbar.BackgroundColor3 = Color3.fromRGB(15, 15, 15) -- Darker topbar
...
frame.Name = "Frame"
frame.BackgroundColor3 = Color3.fromRGB(10, 10, 10) -- Darker frame
...
frame1.BackgroundColor3 = Color3.fromRGB(139, 0, 0) -- Red accent line
...
uIGradient.Color = ColorSequence.new({
  ColorSequenceKeypoint.new(0, Color3.fromRGB(220, 20, 60)), -- Crimson red
  ColorSequenceKeypoint.new(1, Color3.fromRGB(139, 0, 0)), -- Dark red
})
uIGradient.Enabled = false
uIGradient.Parent = frame1

-- Add logo to the right of title
local logoImage
if Info.Logo then
    logoImage = Instance.new("ImageLabel")
    logoImage.Name = "LogoImage"
    logoImage.Image = "rbxassetid://"..tostring(Info.Logo)
    logoImage.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    logoImage.BackgroundTransparency = 1
    logoImage.Position = UDim2.new(0, 60, 0.194, 0) -- Position to the right of title
    logoImage.Size = UDim2.new(0, 17, 0, 17)
    logoImage.ZIndex = 2
...
closeButton.MouseEnter:Connect(function()
    TweenService:Create(closeButton, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = Color3.fromRGB(220, 20, 60)}):Play() -- Red hover
end)
...
minimizeButton.MouseEnter:Connect(function()
    TweenService:Create(minimizeButton, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = Color3.fromRGB(255, 69, 0)}):Play() -- Red-orange hover
end)
...
editButton.MouseButton1Click:Connect(function()
    ...
    if not EditOpened then
        for frame, v in pairs(ColorElements) do
            if v.Enabled then
                if frame.ClassName == "Frame" then
                TweenService:Create(frame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(139, 0, 0)}):Play() -- Changed to red
                else
                TweenService:Create(frame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = Color3.fromRGB(139, 0, 0)}):Play() -- Changed to red
                end
            end
        end
    else
...
tabContainer.BackgroundColor3 = Color3.fromRGB(25, 25, 25) -- Slightly lighter than main background
...
scrollingContainer.ScrollBarImageColor3 = Color3.fromRGB(139, 0, 0) -- Red scrollbar
...
uIStroke.Color = Color3.fromRGB(139, 0, 0) -- Red stroke for tabs
...
leftContainer.BackgroundColor3 = Color3.fromRGB(22, 22, 22) -- Darker container
...
rightContainer.BackgroundColor3 = Color3.fromRGB(22, 22, 22) -- Darker container
...
sectionFrame.BackgroundColor3 = Color3.fromRGB(35, 35, 35) -- Darker section frame
...
uIStroke3.Color = Color3.fromRGB(139, 0, 0) -- Red stroke for sections
...
sectionButton.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(sectionIcon, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = Closed.Value and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(217, 217, 217)}):Play() -- Red close icon
...
keybindFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Darker keybind frame
...
keybindUIStroke.Color = Color3.fromRGB(139, 0, 0) -- Red stroke for keybind
...
inputOuter.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Darker input
...
inputUIStroke.Color = Color3.fromRGB(139, 0, 0) -- Red stroke for input
...
toggleFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Darker toggle
...
function insidetoggle:Set(bool)
    ...
    if not Toggled then
        TweenService:Create(toggleFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(50, 50, 50)}):Play() -- Darker when off
    elseif Toggled and not EditOpened then
        TweenService:Create(toggleFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(139, 0, 0)}):Play() -- Red when on
    end
...
outerSlider.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Darker outer slider
...
innerSlider.BackgroundColor3 = Color3.fromRGB(139, 0, 0) -- Red inner slider
...
-- Fixed slider interaction for mobile support
...
sliderButton.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        ...
        connection1 = UserInputService.InputChanged:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
                if dragging then
...
dropdownContainerTextButton.MouseEnter:Connect(function()
    TweenService:Create(dropdownbuttonText, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(220, 20, 60)}):Play() -- Red hover
end)
...
dropdownContainerTextButton.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(dropdownIcon, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = DropdownOpened and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(191, 191, 191)}):Play() -- Red when opened
...
TweenService:Create(dropdownIcon, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Rotation = DropdownOpened and -180 or -90}):Play()
TweenService:Create(dropdownIcon, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = DropdownOpened and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(191, 191, 191)}):Play()
TweenService:Create(dropdown, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 162, 0, DropdownYSize) or UDim2.new(0, 162, 0, 27)}):Play()
TweenService:Create(dropdownContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = DropdownOpened and UDim2.new(0, 162, 0, DropdownYSize) or UDim2.new(0, 162, 0, 27)}):Play()
TweenService:Create(dropdownContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundTransparency = DropdownOpened and .96 or 1}):Play()
end
...
radioText.Text = text  -- Fixed this line
radioText.TextColor3 = Color3.fromRGB(191, 191, 191)  -- Fixed this line
...
radioTextButton.MouseButton1Click:Connect(function()
    ...
    if not EditOpened then
        TweenService:Create(radioInner, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromRGB(139, 0, 0) or Color3.fromRGB(191, 191, 191)}):Play() -- Red when selected
        TweenService:Create(radioOuter, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromRGB(139, 0, 0) or Color3.fromRGB(191, 191, 191)}):Play() -- Red when selected
    end
end)
...
radioButtonTextButton.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(radioButtonIcon, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(191, 191, 191)}):Play() -- Red when opened
    ...
    TweenService:Create(radioButtonIcon2, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(191, 191, 191)}):Play() -- Red when opened
...
Closed:GetPropertyChangedSignal("Value"):Connect(function()
    ...
    TweenService:Create(radioButtonIcon, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(191, 191, 191)}):Play()
    TweenService:Create(radioButtonIcon, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Rotation = RadioOpened and -180 or -90}):Play()
    TweenService:Create(radioButtonIcon2, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = RadioOpened and Color3.fromRGB(220, 20, 60) or Color3.fromRGB(191, 191, 191)}):Play()
    TweenService:Create(radioButton, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = RadioOpened and UDim2.new(0, 162, 0, RadioYSize) or UDim2.new(0, 162, 0, 27)}):Play()
    TweenService:Create(radioContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = RadioOpened and UDim2.new(0, 162, 0, RadioYSize) or UDim2.new(0, 162, 0, 27)}):Play()
    TweenService:Create(radioContainer, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundTransparency = RadioOpened and .96 or 1}):Play()
    TweenService:Create(sectionFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = RadioOpened and UDim2.new(0, 162, 0, sectionFrame.Size.Y.Offset + RadioYSize - 27) or UDim2.new(0, 162, 0, sectionFrame.Size.Y.Offset - RadioYSize + 27)}):Play()
...
frame2.BackgroundColor3 = Color3.fromRGB(139, 0, 0) -- Red separator line
...
uIStroke2.Color = Color3.fromRGB(139, 0, 0) -- Red main border
