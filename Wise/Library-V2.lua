...
function Library:SetTheme(themeName)
    ...
    for _, window in pairs(self.Windows) do
        ...
        if window.Main then
            ...
            local mainStroke = window.Main:FindFirstChildOfClass("UIStroke")
            if mainStroke then
                mainStroke.Color = Theme.ElementBorder
            end
        end
        
        -- Title
        local titleBar = window.Main:FindFirstChild("TitleBar")
        if titleBar then
        ...
        -- Squircle button
        local squircleBtn = GUI:FindFirstChild("SquircleOpen")
        if squircleBtn then
        ...
        -- Tab buttons
        local tabScrollFrame = window.Main:FindFirstChild("TabScrollFrame")
        if tabScrollFrame then
            tabScrollFrame.ScrollBarImageColor3 = Theme.Accent
            
            for _, tab in pairs(tabScrollFrame:GetChildren()) do
                if tab:IsA("TextButton") then
                    tab.BackgroundColor3 = Theme.Element
                    tab.BackgroundTransparency = Theme.ElementTransparency
        ...
        -- Profile Section
        local profileSection = window.Main:FindFirstChild("ProfileSection")
        if profileSection then
            ...
            local profileStroke = profileSection:FindFirstChildOfClass("UIStroke")
            if profileStroke then
                profileStroke.Color = Theme.ElementBorder
            end
            
            local playerName = profileSection:FindFirstChild("TextLabel")
            if playerName then
                playerName.TextColor3 = Theme.Text
            end
            
            for _, child in pairs(profileSection:GetChildren()) do
        ...
        if window.TabDisplay then
            window.TabDisplay.TextColor3 = Theme.Text
        end
        
        -- Content Area - Update all elements
        local contentArea = window.Main:FindFirstChild("ContentArea")
        if contentArea then
            for _, tabContent in pairs(contentArea:GetChildren()) do
                if tabContent:IsA("ScrollingFrame") then
                    ...
                    Library:UpdateElementColors(tabContent)
                end
            end
        end
    end
...
function Library:UpdateElementColors(container)
    for _, element in pairs(container:GetChildren()) do
        if element:IsA("Frame") or element:IsA("TextButton") then
            -- Update based on element type
            
            -- Buttons
            if element.Name:find("Button") or element:IsA("TextButton") then
                ...
                for _, child in pairs(element:GetChildren()) do
                    if child:IsA("TextLabel") then
                        if child.Name:find("Title") then
                            child.TextColor3 = Theme.Text
                        elseif child.Name:find("Desc") then
                            child.TextColor3 = Theme.SubText
                        end
                    end
                    
                    -- Arrow icon
                    if child.Name == "TextLabel" and child.Text == "→" then
            ...
            if element.Name:find("Toggle") then
                ...
                for _, child in pairs(element:GetDescendants()) do
                    if child:IsA("Frame") and child.Name:find("Slider") then
                        ...
                        local circle = child:FindFirstChild("Frame")
                        if circle and circle.Position.X.Offset > 10 then
                            child.BackgroundColor3 = Theme.Accent
                        else
                            child.BackgroundColor3 = Theme.ElementBorder
                        end
                    end
            ...
            -- Sliders
            if element.Name:find("Slider") then
                element.BackgroundColor3 = Theme.Element
                element.BackgroundTransparency = Theme.ElementTransparency
                ...
                for _, child in pairs(element:GetDescendants()) do
                    if child:IsA("Frame") then
                        if child.Name:find("Container") then
                            child.BackgroundColor3 = Theme.ElementBorder
                        elseif child.Name:find("Fill") or child.Name:find("Dot") then
                            child.BackgroundColor3 = Theme.Accent
                        end
                    end
                    ...
                    if child:IsA("TextLabel") then
                        if child.Name:find("Title") then
                            child.TextColor3 = Theme.Text
                        elseif child.Name:find("Desc") or child.Name:find("Display") then
                            child.TextColor3 = Theme.SubText
                        end
                    end
                end
            ...
            -- Inputs/Textboxes
            if element.Name:find("Input") then
                element.BackgroundColor3 = Theme.Element
                element.BackgroundTransparency = Theme.ElementTransparency
                ...
                for _, child in pairs(element:GetDescendants()) do
                    if child:IsA("Frame") and not child.Name:find("Corner") then
                        child.BackgroundColor3 = Theme.Background
                        
                        local childStroke = child:FindFirstChildOfClass("UIStroke")
                        if childStroke then
                            childStroke.Color = Theme.ElementBorder
                        end
                    end
                    
                    if child:IsA("TextBox") then
                        child.TextColor3 = Theme.Text
                        child.PlaceholderColor3 = Theme.SubText
                    end
            ...
            -- Dropdowns
            if element.Name:find("Dropdown") then
                element.BackgroundColor3 = Theme.Element
                element.BackgroundTransparency = Theme.ElementTransparency
                ...
                for _, child in pairs(element:GetDescendants()) do
                    if child:IsA("TextButton") and child.Name ~= element.Name then
                        child.BackgroundColor3 = Theme.Background
                    ...
                    if child:IsA("TextLabel") then
                        if child.Name:find("Title") then
                            child.TextColor3 = Theme.Text
                        elseif child.Name:find("Desc") or child.Name == "TextLabel" then
                            child.TextColor3 = Theme.SubText
                        end
                    end
                    
                    -- Dropdown list
                    if child:IsA("Frame") and child.Name:find("List") then
                        child.BackgroundColor3 = Theme.Background
                        ...
                        -- Update list options
                        for _, option in pairs(child:GetChildren()) do
            ...
            -- Keybinds
            if element.Name:find("Keybind") then
                element.BackgroundColor3 = Theme.Element
                element.BackgroundTransparency = Theme.ElementTransparency
                ...
                for _, child in pairs(element:GetDescendants()) do
                    if child:IsA("TextButton") and child.Name:find("Display") then
                        child.BackgroundColor3 = Theme.Background
                        child.TextColor3 = Theme.Text
                        
                        local displayStroke = child:FindFirstChildOfClass("UIStroke")
                        if displayStroke then
            ...
            -- Paragraphs
            if element.Name:find("Paragraph") then
                element.BackgroundColor3 = Theme.Element
                ...
                for _, child in pairs(element:GetChildren()) do
                    if child:IsA("TextLabel") then
                        if child.Name:find("Title") then
                            child.TextColor3 = Theme.Text
                        elseif child.Name:find("Content") then
                            child.TextColor3 = Theme.SubText
                        end
                    end
                end
            ...
            -- Sections
            if element.Name:find("Section") then
                -- Update section title
                local sectionTitle = element:FindFirstChild("Title")
                if sectionTitle and sectionTitle:IsA("TextLabel") then
                    sectionTitle.TextColor3 = Theme.Text
                end
                
                -- Recursively update section contents
                Library:UpdateElementColors(element)
            end
        end
    end
end
